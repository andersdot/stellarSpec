...
HOGG: describe why the blue and red points have a different morphology
Bringing the toy model back to our original problem, we can get better estimates of the true parallax for each star by inferring the true parallax from the measured parallax and using the noise-deconvolved \cmd, an estimate of the true \cmd, as our prior.
...
HOGG: Come back to the assumptions. What happens if we change or violate them?
Anderson: Put in citations
HOGG: Long discussion of the noise model. We took serious short-cuts. Call out to Boris.
