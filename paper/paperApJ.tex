...
\author{Lauren Anderson\altaffilmark{1} and David Hogg\altaffilmark{1,2}}
\affil{Center for Computational Astrophysics}

\author{Boris Leistedt\altaffilmark{2}}
\affil{NYU}

\author{Adrian Price-Whelan\altaffilmark{3}}
\affil{Princeton}

\and

\author{Andrew Casey\altaffilmark{4}}
...
\altaffiltext{1}{CCA}
\altaffiltext{2}{NYU}
\altaffiltext{3}{Princeton}
\altaffiltext{4}{Somewhere in the UK}
...
%%% Karol Kozioł for ShareLaTeX
\tablenotetext{1}{Sample footnote for table~\ref{tbl-2} that was
generated with the \LaTeX\ table environment}
\tablenotetext{2}{Yet another sample footnote for table~\ref{tbl-2}}
\tablenotetext{3}{Another sample footnote for table~\ref{tbl-2}}
